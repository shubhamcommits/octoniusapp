...
<html>
	<head>
		<title> Octonius platform - collaborate on a project</title>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		<meta content="IE=7, IE=9" http-equiv="X-UA-Compatible">
		<meta content="width=device-width" name="viewport">
		<link rel="icon" type="image/x-icon" href="http://octoni.us/favicon.ico">
		<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,600' rel='stylesheet' type='text/css'>
		<style type="text/css">
body {font:16px/30px 'Open Sans'; min-width:400px; margin:0; padding:75px 0 0 0; text-align:center;}
h1 {font-weight:normal; font-size:32px; line-height:40px; margin-bottom:10px; padding:0; margin-top:0; }
p {padding:0 0 10px 0; color:#666666}
a {color:#336699;}
textarea {font:12px/18px 'Helvetica', Arial, sans-serif;}

.header {padding-bottom:15px;  text-align: center}
.header span {font-size:22px; text-align: center}
.wrapper {width:540px; margin:0 auto 80px auto; text-align:left;}
.container {position:relative; margin:0; text-align:left; background-color:#ffffff; background:rgba(255,255,255,.9); padding:60px; line-height:150%;border-bottom: 1px solid #ececec; }
.clear {clear:both;}
/* Form */
form {font:16px/20px 'Open Sans'; display:block; padding:15px 0 10px 0; margin-top:15px; border-top:1px solid #ccc;}
label {clear:both; display:block; margin:8px 0; font-weight:bold; position:relative; line-height:150%; font-family:'Open Sans'; font-size: 14px; color: #333333;}
...
.email-group .button {margin:0; min-width:75px;}
...
.success {background:#e4f3d4; font-size:14px; color:#5ca000; margin:10px 0; padding:10px; font-family:'Open Sans';}
...
*, *:before, *:after {
	-moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box;
		...
		@media only screen and (max-width:64em) {
			body { padding-top: 30px; min-width: 100%; }
			.wrapper { width: 96% }
			.container { padding: 30px 15px }
		}
		@media only screen and (max-width:40em) {
			body { background-image: none!important; }
			.email-group input { float: none; width: 100%; margin: 0 0 12px 0; min-width: inherit;}
			.email-group .button { width: 100%; }
		}
		</style>
		<!--[if IE]>
			<style type="text/css">
	...
	<body>
		<div class="wrapper">
			<div class="container">
				<div class="header">
					<h1 class="title"> <img src="http://alpha.octoni.us/static/img/avatar.jpeg" alt="user avatar" style="width: 42px; height: 42px; border-radius: 24px" /> <br><%body%></h1>
					<span class="byline"> Thank you for joining Octonius! </span>
				</div>
				<div class="description"> <p> This email is simply to confirm that your account was succesfully created. No action is required from your side.</p>
					<p>
						Team Octonius
					</p>
				</div>
			...
			<p style="text-align:center">
				<img src="http://octoni.us/img/app.png" alt="Octonius logo" style="width:30px; margin: 2px;  vertical-align: middle"> <span style="color:#2b2b2b">OCTONIUS</span>
				<br>
				<span style="font-size: 10px; text-align:center"> Octonius, Inc. |
					950 Page Mill Road
