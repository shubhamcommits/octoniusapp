...
export class PublicFunctions {
  ...
  async getUserDetailsFromService() {
    return new Promise((resolve) => {
      const utilityService = this.injector.get(UtilityService);
      this.subSink.add(
        utilityService.currentUserData.subscribe((res) => {
          resolve(res);
        })
      );
    });
  ...
  async getUserDetailsFromStorage() {
    ...
    return storageService.existData("userData") === null
      ? {}
      : storageService.getLocalData("userData");
  }
  ...
  async getAccountDetailsFromService() {
    return new Promise((resolve) => {
      const utilityService = this.injector.get(UtilityService);
      this.subSink.add(
        utilityService.currentAccountData.subscribe((res) => {
          resolve(res);
        })
      );
    });
  ...
  async getAccountDetailsFromStorage() {
    const storageService = this.injector.get(StorageService);
    return storageService.existData("accountData") === null
      ? {}
      : storageService.getLocalData("accountData");
  }
  ...
  async getWorkspaceDetailsFromService() {
    return new Promise((resolve) => {
      const utilityService = this.injector.get(UtilityService);
      this.subSink.add(
        utilityService.currentWorkplaceData.subscribe((res) => {
          resolve(res);
        })
      );
    });
  ...
  async getWorkspaceDetailsFromStorage() {
    const storageService = this.injector.get(StorageService);
    return storageService.existData("workspaceData") === null
      ? {}
      : storageService.getLocalData("workspaceData");
  }
  ...
  async getWorkspaceDetailsFromHTTP() {
    return new Promise(async (resolve, reject) => {
      ...
      if (utilityService.objectExists(userData)) {
        this.subSink.add(
          workspaceService
            .getWorkspace(userData["_workspace"])
            .pipe(retry(1))
            .subscribe(
              (res) => {
              ...
              (err) => {
                console.log(
                  "Error occurred while fetching the workspace details!",
                  err
                );
                utilityService.errorNotification(
                  $localize`:@@publicFunctions.errorOccuredWhileFetchingWorkspaceDetails:Error occurred while fetching the workspace details, please try again!`
                );
                reject(err);
              }
            )
  ...
  async getWorkspaceMembers(workspaceId?: string) {
    return new Promise(async (resolve, reject) => {
      ...
      const utilityService = this.injector.get(UtilityService);
      workspaceService
        .getWorkspaceMembers(workspaceId || userData["_workspace"])
        .then((res) => {
          resolve(res["users"]);
        })
        .catch((err) => {
          console.log(
            "Error occurred while fetching the workspace members!",
            err
          );
          utilityService.errorNotification(
            $localize`:@@publicFunctions.errorOccuredWhileFetchingWorkspaceMembers:Error occurred while fetching the workspace members!, please try again!`
          );
          reject(err);
        });
    });
  ...
  async getGroupMembersSocialStats(groupId: string, numDays: string) {
    return new Promise(async (resolve, reject) => {
      ...
      const utilityService = this.injector.get(UtilityService);
      groupService
        .getGroupMembersSocialStats(groupId, numDays)
        .then((res) => {
          resolve(res["users"]);
        })
        .catch((err) => {
  ...
  async getWorkspaceMembersSocialStats(
    workspaceId: string,
    numDays: string,
    filteringGroups: any
  ) {
    return new Promise(async (resolve, reject) => {
      ...
      const utilityService = this.injector.get(UtilityService);
      workspaceService
        .getWorkspaceMembersSocialStats(
  ...
  async getCurrentGroupFromService() {
    return new Promise((resolve) => {
      const utilityService = this.injector.get(UtilityService);
      this.subSink.add(
        utilityService.currentGroupData.subscribe((res) => {
          resolve(res);
        })
      );
    });
  ...
  async getGroupDetailsFromStorage() {
    const storageService = this.injector.get(StorageService);
    return storageService.existData("groupData") === null
      ? {}
      : storageService.getLocalData("groupData");
  }
    ...
    return new Promise((resolve, reject) => {
      ...
      groupService
        ...
        .catch((err) => {
          this.sendError(
            new Error(
              $localize`:@@publicFunctions.unableToFetchGroupDetails:Unable to fetch the group details, please try again!`
            )
          );
          reject(err);
        });
  ...
  async getCurrentPortfolioFromService() {
    return new Promise((resolve) => {
      const utilityService = this.injector.get(UtilityService);
      this.subSink.add(
        utilityService.currentPortfolioData.subscribe((res) => {
          resolve(res);
        })
      );
    });
  ...
  async getPortfolioDetailsFromStorage() {
    const storageService = this.injector.get(StorageService);
    return storageService.existData("portfolioData") === null
      ? {}
      : storageService.getLocalData("portfolioData");
  }
    ...
    return new Promise((resolve, reject) => {
      ...
      portfolioService
        ...
        .catch((err) => {
          this.sendError(
            new Error(
              $localize`:@@publicFunctions.unableToFetchPortfolioDetails:Unable to fetch the portfolio details, please try again!`
            )
          );
          reject(err);
        });
  ...
  isPersonalNavigation(groupData: any, userData: any) {
    return groupData && userData
      ? groupData?.group_name === "personal" &&
        groupData?._id ==
          (userData?._private_group?._id || userData?._private_group)
        ? true
        : false
      : true;
  }
  ...
  getRouterStateFromService() {
    return new Promise((resolve) => {
      const utilityService = this.injector.get(UtilityService);
      this.subSink.add(
        utilityService.routerStateData.subscribe((res) => {
  ...
  getLoungeFromService() {
    return new Promise((resolve) => {
      const utilityService = this.injector.get(UtilityService);
      this.subSink.add(
        utilityService.loungeData.subscribe((res) => {
          if (!utilityService.objectExists(res)) {
            resolve(res);
          }
        })
  ...
  getStoryFromService() {
    return new Promise((resolve) => {
      const utilityService = this.injector.get(UtilityService);
      this.subSink.add(
        utilityService.storyData.subscribe((res) => {
          if (!utilityService.objectExists(res)) {
            resolve(res);
          }
        })
  ...
  public async getCalendarPosts(
    ...
    return new Promise((resolve, reject) => {
      postService
        .getCalendarPosts(year, month, groupId, userId)
  ...
  membersNotInGroup(workspaceId: string, query: string, groupId: string) {
    try {
      return new Promise(async (resolve) => {
        ...
        let users = await workspaceService.getMembersNotInGroup(
          workspaceId,
          query,
          groupId
        );
  ...
  getNextGroupMembers(groupId: string, lastUserId: string, query: string) {
    return new Promise((resolve, reject) => {
      ...
      groupService
        .getNextGroupMembers(groupId, lastUserId, query)
        .then((res) => {
          // Resolve with sucess
          resolve(res["users"]);
        })
  ...
  public async getUserGroups(workspaceId: string, userId: string) {
    return new Promise((resolve, reject) => {
      let groupsService = this.injector.get(GroupsService);
      groupsService
        .getUserGroups(workspaceId, userId)
   ...
   * @param lastGroupId
   */
  public async getNextUserGroups(
    workspaceId: string,
    userId: string,
    lastGroupId: string
  ) {
    return new Promise((resolve, reject) => {
      let groupsService = this.injector.get(GroupsService);
      groupsService
        .getNextUserGroups(workspaceId, userId, lastGroupId)
        .then((res) => resolve(res["groups"]))
        .catch(() => reject([]));
    });
  }
  ...
  public async getAllManagerGroups(workspaceId: string, userId: string) {
    return new Promise((resolve, reject) => {
      let groupsService = this.injector.get(GroupsService);
      groupsService
        .getAllManagerGroups(workspaceId, userId)
        .then((res) => resolve(res["groups"]))
        .catch(() => reject([]));
    });
  }
  ...
  async getShuttleGroups(workspaceId: string, groupId: string) {
    return new Promise((resolve, reject) => {
      let workspaceService = this.injector.get(WorkspaceService);
      workspaceService
        .getShuttleGroups(workspaceId, groupId)
        .then((res) => resolve(res["groups"]))
        .catch(() => reject([]));
    });
  }
  ...
  searchAllGroupsList(workspaceId: string, query: string, groupId: string) {
    try {
      return new Promise(async (resolve) => {
        ...
        // Fetch the users based on the query and groupId
        await searchService
          .searchAllGroupsList(workspaceId, query, groupId)
          .then((res) => {
            // Resolve with success
            resolve(res["groups"]);
          });
  ...
  searchAllUsersList(workspaceId: string, query: string) {
    try {
      return new Promise(async (resolve) => {
        ...
        // Fetch the users based on the query and groupId
        await searchService
          .searchAllUsersList(workspaceId, query)
          .then((res) => {
            // Resolve with success
            resolve(res["users"]);
          });
  ...
  public async getUserFavoritePortfolios(userId: string) {
    return new Promise((resolve, reject) => {
      let usersService = this.injector.get(UserService);
      usersService
        .getUserFavoritePortfolios(userId)
   ...
   * @param userData
   */
  public async userDetailsServiceFunction(
  ...
  searchWorkspaceMembers(workspaceId: string, query: string) {
    try {
      return new Promise(async (resolve) => {
        ...
        let users = await workspaceService.getWorkspaceMembers(
          workspaceId,
          query
        );
  ...
  getNextWorkspaceMembers(
    ...
    return new Promise((resolve, reject) => {
      ...
      // Fetch the users from server
      workspaceService
        .getNextWorkspaceMembers(workspaceId, lastUserId, query)
        .then((res) => {
          // Resolve with sucess
          resolve(res["users"]);
        })
  ...
  getPosts(
    ...
    return new Promise((resolve, reject) => {
      postService
        .getPosts(groupId, type, pinned, lastPostId, filters)
        .then((res: any) => {
          // Resolve with sucess
          resolve(res["posts"]);
        })
  ...
  getFiles(groupId: string, folderId: string, lastFileId?: string) {
    ...
    return new Promise((resolve, reject) => {
      filesService
        .get(groupId, folderId, lastFileId)
        .then((res: any) => {
          // Resolve with sucess
          resolve(res["files"]);
        })
  ...
  getFilteredFiles(
    ...
    return new Promise((resolve, reject) => {
      filesService
        .getFilteredFiles(groupId, folderId, filterBit, filterData)
        .then((res: any) => {
          // Resolve with sucess
          resolve(res["files"]);
        })
  ...
  searchFiles(
    ...
    return new Promise((resolve) => {
      let filesService = this.injector.get(FilesService);
      filesService
        .searchFiles(groupId, query, workspaceId, groupRef)
  ...
  searchPages(groupId: string, query: any, workspaceId: string) {
    return new Promise((resolve) => {
      ...
      libraryService
        .searchPages(groupId, query, workspaceId)
  ...
  onEditPost(postId: string, workspaceId: string, postData: FormData) {
    ...
    return new Promise((resolve, reject) => {
      postService
        .edit(postId, workspaceId, postData)
        .then((res) => {
          // Resolve with success
          resolve(res["post"]);
        })
  ...
  changeTaskAssignee(postId: string, assigneeId: string) {
    ...
    utilityService.asyncNotification(
      $localize`:@@publicFunctions.pleaseWaitWeChangeTaskAssignee:Please wait we are changing the task assignee...`,
      new Promise(async (resolve, reject) => {
        const isShuttleTasksModuleAvailable =
          await this.isShuttleTasksModuleAvailable();
        const isIndividualSubscription =
          await this.checkIsIndividualSubscription();
          ...
          .then((res) => {
            resolve(
              utilityService.resolveAsyncPromise(
                $localize`:@@publicFunctions.taskAssigned:Task assigned to ${res["post"]["task"]["_assigned_to"]["first_name"]}`
              )
            );
          })
          .catch(() => {
            reject(
              utilityService.rejectAsyncPromise(
                $localize`:@@publicFunctions.unableToAssign:Unable to assign the new assignee, please try again!`
              )
            );
          });
      })
  ...
  changeTaskDueDate(postId: string, dueDate: string) {
    ...
    utilityService.asyncNotification(
      $localize`:@@publicFunctions.pleaseWaitChangingTaskDueDate:Please wait we are changing the task due date...`,
      new Promise(async (resolve, reject) => {
        const isShuttleTasksModuleAvailable =
          await this.isShuttleTasksModuleAvailable();
        const isIndividualSubscription =
        ...
        postService
          ...
          .then((res) => {
            resolve(
              utilityService.resolveAsyncPromise(
                $localize`:@@publicFunctions.taskDueDAteChanged:Task due date changed to ${datesService.formateDate(
                  dueDate
                )}!`
              )
            );
          ...
          .catch(() => {
            reject(
              utilityService.rejectAsyncPromise(
                $localize`:@@publicFunctions.unableToChangeDueDate:Unable to change the due date, please try again!`
              )
            );
          });
      })
  ...
  async changeTaskStatus(
    ...
    // Call HTTP Request to change the request
    return postService.changeTaskStatus(
      postId,
      status,
      userId,
      groupId,
  ...
  changeTaskColumn(
    ...
    utilityService.asyncNotification(
      $localize`:@@publicFunctions.pleaseWaitWeAreMovingTaskToSection:Please wait we are moving the task to a new section...`,
      new Promise(async (resolve, reject) => {
        const isShuttleTasksModuleAvailable =
          await this.isShuttleTasksModuleAvailable();
        const isIndividualSubscription =
        ...
        await postService
          ...
          .then(async (res) => {
            ...
            resolve(
              utilityService.resolveAsyncPromise(
                $localize`:@@publicFunctions.tasksMoved:Task moved`
              )
            );
          })
          .catch(() => {
            reject(
              utilityService.rejectAsyncPromise(
                $localize`:@@publicFunctions.unableToMoveTask:Unable to move the task, please try again!`
              )
            );
          });
      })
  ...
  async changeTaskShuttleStatus(
    ...
    // Call HTTP Request to change the request
    return postService.selectShuttleStatus(
      postId,
      groupId,
      status,
      isShuttleTasksModuleAvailable,
   ...
   * @param title
   */
  async changeTaskShuttleSection(
    postId: string,
    groupId: string,
    shuttleSectionId: string
  ) {
    let postService = this.injector.get(PostService);
    let utilityService = this.injector.get(UtilityService);
    ...
    utilityService.asyncNotification(
      $localize`:@@publicFunctions.plesaeWaitWeAreUpdaing:Please wait we are updating the contents...`,
      new Promise(async (resolve, reject) => {
        await postService
          .selectShuttleSection(
            postId,
            groupId,
            shuttleSectionId,
            isShuttleTasksModuleAvailable,
          ...
          .then(async (res) => {
            resolve(
              utilityService.resolveAsyncPromise(
                $localize`:@@publicFunctions.detailsUpdated:Details updated!`
              )
            );
          })
          .catch(() => {
            reject(
              utilityService.rejectAsyncPromise(
                $localize`:@@publicFunctions.unableToUpdateDetails:Unable to update the details, please try again!`
              )
            );
          });
      })
  ...
  emitWorkspaceData(socketService: SocketService, workspaceData: any) {
    return socketService
      .onEmit("workspaceData", workspaceData)
      .pipe(retry(Infinity))
      .subscribe();
  }
  ...
  emitUserData(socketService: SocketService, userId: string, userData: Object) {
    return socketService
      .onEmit("userData", userId, userData)
      .pipe(retry(Infinity))
      .subscribe();
  }
  ...
  async sendError(err: Error) {
    let utilityService = this.injector.get(UtilityService);
    console.log(
      "There's some unexpected error occurred, please try again!",
      err
    );
  ...
  async getAgoraGroupsNotJoined(workplaceId, userId) {
    ...
    return new Promise((resolve, reject) => {
      groupService
        .getAgoraGroupsNotJoined(workplaceId, userId)
        .then((res) => {
          resolve(res["group"]);
        })
        .catch((err) => {
  ...
  async joinAgora(groupId, userId) {
    ...
    let utilityService = this.injector.get(UtilityService);
    utilityService.asyncNotification(
      $localize`:@@publicFunctions.joiningGroup:Joining Group...`,
      new Promise((resolve, reject) => {
        groupService
          .joinAgora(groupId, userId)
          .then((res) => {
            resolve(
              utilityService.resolveAsyncPromise(
                $localize`:@@publicFunctions.successfullyJoinedGroup:Successfully Joined Group`
              )
            );
          })
          .catch((err) => {
  ...
  async getNextAgoraGroups(workspaceId, userId, lastGroupId) {
    ...
    return new Promise((resolve, reject) => {
      groupService
        .getNextAgoraGroups(workspaceId, userId, lastGroupId)
        .then((res) => {
          resolve(res["group"]);
        })
        .catch((err) => {
  ...
  async executedAutomationFlowsPropertiesFront(
    flows: any[],
    post: any,
    groupId: string,
    isCreationTaskTrigger?: boolean,
    shuttleIndex?: number
  ) {
    const isIndividualSubscription = await this.checkIsIndividualSubscription();
        ...
        flows.forEach((flow, flowIndex) => {
          ...
          if (steps && steps.length > 0) {
            steps.forEach(async (step, stepIndex) => {
              doTrigger = this.doesTriggersMatch(
                step.trigger,
                post,
                groupId,
              ...
              if (doTrigger) {
                const childStatusTriggerIndex = !!step.trigger
                  ? step.trigger.findIndex((trigger) => {
                      return trigger.name.toLowerCase() == "subtasks status";
                    })
                  : -1;
                post = await this.executeActionFlow(
                  flows,
                  flowIndex,
                  stepIndex,
                  post,
                  childStatusTriggerIndex != -1,
                  groupId,
                  shuttleIndex
                );
              }
          ...
          switch (trigger.name) {
            case "Assigned to":
              if (!!post?.task?._parent_task) {
                ...
                const usersMatch = trigger._user.filter((triggerUser) => {
                  return (
                    (!!post._assigned_to
                      ? post._assigned_to.findIndex((assignee) => {
                          return (
                            (assignee._id || assignee).toString() ==
                            (triggerUser._id || triggerUser).toString()
                          );
                        })
                      : -1) != -1
                  );
            ...
            case "Custom Field":
              if (!!post?.task?._parent_task) {
                ...
                retValue =
                  post.task.custom_fields[
                    trigger.custom_field.name
                  ].toString() == trigger.custom_field.value.toString();
              }
              return Promise.resolve({});
            case "Section is":
              if (!!post?.task?._parent_task) {
                if (post?.task?.shuttle_type && shuttleIndex >= 0) {
                  const triggerSection =
                    trigger._section._id || trigger._section;
                  const postSection =
                    post.task.shuttles[shuttleIndex]._shuttle_section._id ||
                    post.task.shuttles[shuttleIndex]._shuttle_section;
                  retValue =
                    triggerSection.toString() == postSection.toString();
                } else {
                  retValue = false;
                }
              } else {
                const triggerSection =
                  trigger && trigger._section
                    ? trigger._section._id || trigger._section
                    : "";
                let postSection;
                if (post?.task?.shuttle_type && shuttleIndex >= 0) {
            ...
            case "Subtasks Status":
              ...
              if (
                retValue &&
                post.task._parent_task &&
                trigger.subtaskStatus.toUpperCase() ==
                  post.task.status.toUpperCase()
              ) {
                postService
                  .getSubTasks(
                    post.task._parent_task._id || post.task._parent_task
                  )
                  .then((res) => {
                    res["subtasks"].forEach((subtask) => {
                      if (retValue && subtask._id != post._id) {
                        retValue =
                          trigger.subtaskStatus.toUpperCase() ==
                          subtask.task.status.toUpperCase();
                      }
                    });
                  });
              } else {
            ...
            case "Approval Flow is Completed":
              if (post.approval_active && post.approval_flow_launched) {
                retValue = await this.isApprovalFlowCompleted(
                  post.approval_flow
                );
              } else {
                retValue = false;
  ...
  async executeActionFlow(
    ...
    const shuttleActinIndex =
      ...
      !!flows[flowIndex].steps[stepIndex].action
        ? flows[flowIndex].steps[stepIndex].action.findIndex(
            (action) => action.name == "Shuttle task"
          )
        : -1;

    const executeShuttleAction =
      shuttleActinIndex < 0 || isShuttleTasksModuleAvailable;
        ...
        switch (action.name) {
          case "Assign to":
            action._user.forEach(async (userAction) => {
              const indexAction = !!post._assigned_to
                ? post._assigned_to.findIndex(
                    (assignee) =>
                      (assignee._id || assignee) ==
                      (userAction._id || userAction)
                  )
                : -1;
              if (indexAction < 0) {
  ...
  async checkFlamingoStatus(workspaceId: string, mgmtApiPrivateKey: string) {
    ...
    return managementPortalService
      .getFlamingoStatus(workspaceId, mgmtApiPrivateKey)
      .then((res) => {
        if (!res || !res["status"]) {
          return false;
        }
  ...
  async checkIdeaStatus(workspaceId?: string, mgmtApiPrivateKey?: string) {
    ...
    const managementPortalService = this.injector.get(ManagementPortalService);
    return managementPortalService
      .getIdeaStatus(workspaceId, mgmtApiPrivateKey)
      .then((res) => {
        if (!res || !res["status"]) {
          return false;
        }
  ...
  async isShuttleTasksModuleAvailable() {
    ...
    return managementPortalService
      .isShuttleTasksModuleAvailable(
        workspace?._id,
        workspace?.management_private_api_key
      )
      .then((res) => {
        if (!res || !res["status"]) {
          return false;
  ...
  async isFilesVersionsModuleAvailable() {
    ...
    const managementPortalService = this.injector.get(ManagementPortalService);
    return managementPortalService
      .isFilesVersionsModuleAvailable(
        workspace?._id,
        workspace?.management_private_api_key
      )
      .then((res) => {
  ...
  getNextAllGroupsList(workspaceId: string, lastWorkspaceId: string) {
    return new Promise((resolve, reject) => {
      ...
      // Fetch the groups from server
      groupsService
        .getNextAllGroupsList(workspaceId, lastWorkspaceId)
        .then((res) => {
          // Resolve with sucess
          resolve(res["groups"]);
        })
  ...
  getAllArchivedGroupsList(workspaceId: string) {
    return new Promise((resolve, reject) => {
      ...
      // Fetch the groups from server
      groupsService
        .getAllArchivedGroupsList(workspaceId)
        .then((res) => {
          // Resolve with sucess
          resolve(res["groups"]);
        })
  ...
  getNextAllArchivedGroupsList(workspaceId: string, lastWorkspaceId: string) {
    return new Promise((resolve, reject) => {
      ...
      // Fetch the groups from server
      groupsService
        .getNextAllArchivedGroupsList(workspaceId, lastWorkspaceId)
        .then((res) => {
          // Resolve with sucess
          resolve(res["groups"]);
        })
  ...
  searchWorkspaceActiveGroups(workspaceId: string, query: string) {
    try {
      return new Promise(async (resolve) => {
        ...
        let groups = await groupsService.getWorkspaceActiveGroups(
          workspaceId,
          query
        );
  ...
  searchWorkspaceArchivedGroups(workspaceId: string, query: string) {
    try {
      return new Promise(async (resolve) => {
        ...
        let groups = await groupsService.getWorkspaceArchivedGroups(
          workspaceId,
          query
        );
  ...
  selectPermissionRight(
    ...
    switch (type) {
      ...
      case "folder":
        // Create service instance
        let foldersService = this.injector.get(FoldersService);
        return foldersService.selectPermissionRight(
          permissionId,
          itemId,
          right
        );
  ...
  addMemberToPermission(
    ...
    switch (type) {
      ...
      case "folder":
        // Create service instance
        let foldersService = this.injector.get(FoldersService);
        return foldersService.addMemberToPermission(
          itemId,
          permissionId,
          member
        );
      ...
      case "section":
        // Create service instance
        let columnService = this.injector.get(ColumnService);
        return columnService.addMemberToPermission(
          itemId,
          permissionId,
          member
        );
  ...
  removeMemberFromPermission(
    ...
    switch (type) {
      case "file":
        // Create service instance
        let filesService = this.injector.get(FilesService);
        return filesService.removeMemberFromPermission(
          itemId,
          permissionId,
          memberId
        );
      case "folder":
        // Create service instance
        let foldersService = this.injector.get(FoldersService);
        return foldersService.removeMemberFromPermission(
          itemId,
          permissionId,
          memberId
        );
      case "post":
        // Create service instance
        let postService = this.injector.get(PostService);
        return postService.removeMemberFromPermission(
          itemId,
          permissionId,
          memberId
        );
      case "section":
        // Create service instance
        let columnService = this.injector.get(ColumnService);
        return columnService.removeMemberFromPermission(
          itemId,
          permissionId,
          memberId
        );
  ...
  async getPossibleIntegrations() {
    ...
    let possibleIntegrations = {
      is_on_premise_environment: !(
        environment.clientUrl == "app.octonius.com" ||
        environment.clientUrl == "v1.apps.octonius.com" ||
        environment.clientUrl.includes("localhost")
      ),
    ...
    allWorkspacesIntegratinos.forEach((workspace) => {
      if (workspace.integrations) {
        if (
          !possibleIntegrations.is_google_connected &&
          workspace.integrations.is_google_connected
        ) {
          possibleIntegrations.is_google_connected =
            workspace.integrations.is_google_connected;
          possibleIntegrations.google_client_id =
            workspace.integrations.google_client_id;
          possibleIntegrations.google_client_secret_key =
            workspace.integrations.google_client_secret_key;
        }
        if (
          !possibleIntegrations.is_azure_ad_connected &&
          workspace.integrations.is_azure_ad_connected
        ) {
          possibleIntegrations.is_azure_ad_connected =
            workspace.integrations.is_azure_ad_connected;
          possibleIntegrations.azure_ad_clientId =
            workspace.integrations.azure_ad_clientId;
          possibleIntegrations.azure_ad_authority_cloud_url =
            workspace.integrations.azure_ad_authority_cloud_url;
        }
        if (
          !possibleIntegrations.is_ldap_connected &&
          workspace.integrations.is_ldap_connected
        ) {
          possibleIntegrations.is_ldap_connected =
            workspace.integrations.is_ldap_connected;
        }
  ...
  async getAllWorkspaces() {
    ...
    return new Promise(async (resolve) => {
      await await authService.getAllWorkspacesIntegrations().then((res) => {
        if (res) {
          resolve(res["workspace"]);
        }
      });
  ...
  async suggestMembers(
    ...
    if (groupId) {
      ...
      usersList = await this.searchWorkspaceMembers(
        workspaceData?._id,
        searchTerm
      );
    }
  ...
  async suggestFiles(searchVal: string, groupId: string, workspaceData: any) {
    ...
    //   })
    // );
    const serviceGoogleResult = await this.getGoogleSuggestedFiles(
      searchVal,
      workspaceData?.integrations?.is_google_connected
    );
    const serviceBoxResult = await this.getBoxSuggestedFiles(
      searchVal,
      workspaceData?.integrations
    );
    const serviceMS365Result = await this.getMS365SuggestedFiles(
      searchVal,
      workspaceData?.integrations?.is_ms_365_connected
    );
    const serviceOctoniusResult = await this.getOctoniusSuggestedFiles(
      searchVal,
      groupId,
      workspaceData?._id
    );
    ...
    return Array.from(
      new Set([
        ...
        ...serviceBoxResult,
        ...serviceMS365Result,
        ...serviceOctoniusResult,
      ])
    );
  }

  private async getGoogleSuggestedFiles(
    searchVal: string,
    ...
    if (storageService.existData("googleUser") && isGoogleConnected) {
      ...
      if (utilityService.objectExists(googleUser)) {
        ...
        googleFilesList =
          (await integrationsService.searchGoogleFiles(
            searchVal,
            accessToken
          )) || [];
  ...
  private async getBoxSuggestedFiles(searchVal: string, integrations: any) {
    ...
    if (storageService.existData("boxUser") && integrations?.is_box_connected) {
      ...
      if (utilityService.objectExists(boxUser)) {
        ...
        // Get Box file list
        boxFilesList =
          (await integrationsService.searchBoxFiles(
            searchVal,
            boxAccessToken,
            integrations
          )) || [];
  ...
  private async getMS365SuggestedFiles(
    searchVal: string,
    ...
    if (storageService.existData("ms365User") && isMS365Connected) {
      ...
      if (utilityService.objectExists(ms365User)) {
        // Get MS365 file list
        ms365FilesList =
          (await integrationsService.searchMS365Files(searchVal)) || [];
  ...
  private async getOctoniusSuggestedFiles(
    searchVal: string,
    groupId: string,
    workspaceId: string
  ) {
    ...
    let filesList: any = [];
    if (groupId) {
      filesList = await this.searchFiles(
        groupId,
        searchVal,
        workspaceId,
        "true"
   ...
   * @param groupId: string
   */
  async suggestCollectionPages(
    searchVal: string,
    groupId: string,
    workspaceData: any
  ) {
    // Storage Service Instance
    let pagesList: any = await this.searchPages(
      groupId,
      searchVal,
      workspaceData._id
    );
  ...
  async suggestCollection(groupId: string, searchVal: string) {
    let libraryService = this.injector.get(LibraryService);
    let collectionList = await libraryService
      .getCollectionsByGroup(groupId)
    ...
    if (searchVal) {
      collectionList = collectionList
        .filter((collection: any) =>
          collection.name.toLowerCase().includes(searchVal.toLowerCase())
        )
        .map((collection: any) =>
          // {
      ...
      .map((post: any) =>
        ...
        ({
          ...
          value: `${
            post.title
              ? `${post.title} - ${
                  post._posted_by.first_name
                } ${post._posted_by.last_name.slice(0, 1)}.`
              : `untitled - ${
                  post._posted_by.first_name
                } ${post._posted_by.last_name.slice(0, 1)}.`
          }`,
  ...
  async getFileUrl(file: any, workspaceId: string) {
    ...
    if (file?.type == "folio") {
      ...
      const lastFileVersion: any = await utilityService.getFileLastVersion(
        file?._id
      );
  ...
  async getLibreOfficeURL(file: any, workspaceId: string) {
    ...
    const useMS365 =
      workspaceData.integrations.is_ms_365_connected &&
      !!workspaceData.integrations.ms_365_online_host;

    if (useMS365) {
      await ms365CloudService
        .getOfficeWOPIUrl()
        .then((res) => {
          if (res["msData"]) {
            const actions: { [key: string]: [[string, string]] } = res["data"];
            if (actions[fileExt]) {
              for (let [key, [name, action]] of Object.entries(
                actions[fileExt]
              )) {
                if (name !== "editnew") {
                  ...
                  wopiClientURL = `${action}${
                    action.endsWith("?") ? "" : "&"
                  }WOPISrc=${encodeURIComponent(
                    `${wopiServer}/wopi/files/${fileId}`
                  )}&access_token=${token}|${userName}&access_token_ttl=${ttl}`;
                }
              }
            }
          }
        ...
        .catch((error) => {
          utilityService.errorNotification(
            $localize`:@@publicFunctions.errorRetrievingLOOLUrl:Not possible to retrieve the complete Office Online url`
          );
        });
    } else {
      await libreofficeService
        ...
        .then((res) => {
          ...
          if (res["url"]) {
            wopiClientURL =
              ...
              "WOPISrc=" +
              `${
                environment.UTILITIES_BASE_API_URL
              }/libreoffice/wopi/files/${fileId}/${workspaceId}?access_token=${
                storageService.getLocalData("authToken")["token"]
              }`;
          }
        })
  ...
  async suggestMembersForChat(searchTerm: string, chatData: any) {
    ...
    let usersList: any = [];
    if (chatData._group) {
      usersList = await this.searchGroupMembers(
        chatData?._group?._id || chatData?._group,
        searchTerm
      );
      ...
      usersList = await chatData?.members
        ?.map((member) => {
          return {
        ...
        .filter((user) =>
          user.value.toUpperCase().includes(searchTerm.toUpperCase())
        );
    }
  ...
  async getUnreadChats() {
    ...
    return new Promise(async (resolve) => {
      await await chatService.getUnreadChats().then((res) => {
        if (res) {
  ...
  async filterRAGTasks(tasks: any, userData: any) {
    ...
    if (tasks) {
      tasks = await tasks.filter((task) =>
        utilityService.objectExists(task?._group)
      );
      // Filtering other tasks
      tasks.forEach(async (task) => {
        // if (utilityService.objectExists(task?._group)) {
        if (task?.permissions && task?.permissions?.length > 0) {
          const groupData = await this.getGroupDetails(
            task?._group?._id || task?._group
          );
          const canEdit = await utilityService.canUserDoTaskAction(
            task,
            groupData,
            userData,
            "edit"
          ...
          let canView = false;
          if (!canEdit) {
            const hide = await utilityService.canUserDoTaskAction(
              task,
              groupData,
              userData,
              "hide"
            ...
            canView =
              (await utilityService.canUserDoTaskAction(
                task,
                groupData,
                userData,
                "view"
  ...
  async checkIsIndividualSubscription() {
    ...
    let status = false;
    let managementPortalService = this.injector.get(ManagementPortalService);
    await managementPortalService
      .checkIsIndividualSubscription(
        workspace._id,
        workspace.management_private_api_key
      )
      .then((res) => {
