...
import { CRMCompanyContactsComponent } from "./crm-setup-page/crm-company-details-dialog/crm-company-contacts/crm-company-contacts.component";
import { CRMCompanyTasksComponent } from "./crm-setup-page/crm-company-details-dialog/crm-company-tasks/crm-company-tasks.component";
import { CRMCompanyTaskInformationComponent } from "./crm-setup-page/crm-company-details-dialog/crm-company-tasks/crm-company-task-information/crm-company-task-information.component";
import { CRMCompanyUpdatesComponent } from "./crm-setup-page/crm-company-details-dialog/crm-company-updates/crm-company-updates.component";
import { CRMCompanyUpdateInformationComponent } from "./crm-setup-page/crm-company-details-dialog/crm-company-updates/crm-company-update-information/crm-company-update-information.component";
...
@NgModule({
  declarations: [
    ...
    CRMCompanyDetailsDialogComponent,
    CRMCompanyContactsComponent,
    CRMCompanyDetailsComponent,
    CRMCompanyTasksComponent,
    CRMCompanyTaskInformationComponent,
    CRMCompanyUpdatesComponent,
    CRMCompanyInformationComponent,
    CRMCompanyUpdateInformationComponent,
    CRMCompanyInformationComponent,
