...
@Component({
  selector: 'app-user-google-sync',
  templateUrl: './user-google-sync.component.html',
  styleUrls: ['./user-google-sync.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class UserGoogleSyncComponent implements OnInit {
