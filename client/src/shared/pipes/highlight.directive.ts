...
export class HighlightDirective implements OnChanges {
  ...
  ngOnChanges(): void {
    ...
    if (!this.searchedWord || !this.searchedWord.length) {
      // const memberHTML = `<app-avatar  [photoUrl]="${this.baseUrl}/${this.workspaceId}/${this.content.profile_pic}?noAuth=true" [userData]="${this.content}" style="width:30px !important;height:30px !important;" [styleClass]="'feed-avatar'" [noAuth]="true"></app-avatar>`
