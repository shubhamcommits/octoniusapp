...
export class PostService {
  ...
  baseRecurrencyURL = environment.POST_BASE_API_URL + "/post/recurrency";
  ...
  create(workspaceId: string, formData: FormData) {
    ...
    return this._http
      .post(this.baseURL + `/${workspaceId}`, formData)
      .toPromise();
  }
  ...
  edit(postId: string, workspaceId: string, formData: FormData) {
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/edit/${workspaceId}`, formData)
      .toPromise();
  }
  ...
  editTitle(postId: string, postTitle: string) {
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/title`, { postTitle })
      .toPromise();
  }
  ...
  get(postId: string) {
    // Call the HTTP Request
    return this._http.get(this.baseURL + `/${postId}`).toPromise();
  }
  ...
  like(postId: string) {
    // Call the HTTP Request
    return this._http.post(this.baseURL + `/${postId}/like`, "").toPromise();
  }
  ...
  unlike(postId: string) {
    // Call the HTTP Request
    return this._http.post(this.baseURL + `/${postId}/unlike`, "").toPromise();
  }
  ...
  follow(postId: string) {
    // Call the HTTP Request
    return this._http.post(this.baseURL + `/${postId}/follow`, "").toPromise();
  }
  ...
  unfollow(postId: string) {
    // Call the HTTP Request
    return this._http
      .post(this.baseURL + `/${postId}/unfollow`, "")
      .toPromise();
  }
  ...
  getTasksBySection(sectionId: string, isShuttleTasksModuleAvailable: boolean) {
    return this._http.get(this.baseURL + `/tasksBySection/${sectionId}`, {
      params: { isShuttleTasksModuleAvailable },
    });
  }
   ...
   * @param lastPostId - optional
   */
  getTasksBySectionPromise(
    sectionId: string,
    isShuttleTasksModuleAvailable: boolean
  ) {
    return new Promise(async (resolve) => {
      this.getTasksBySection(
        sectionId,
  ...
  getCalendarPosts(year: any, month: any, groupId: string, userId?: string) {
    if (userId) {
      return this._http
        .get(this.baseURL + `/calendar/timeline`, {
          params: {
            year: year,
            month: month,
            groupId: groupId,
  ...
  removeAssigneeFromPost(postId: string, assigneeId: string) {
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/remove-assignee`, {
  ...
  addAssigneeToPost(
    ...
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/add-assignee`, {
        assigneeId: assigneeId,
        groupId: groupId,
  ...
  changeTaskAssignee(
    ...
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/task-assignee`, {
        assigneeId: assigneeId,
        isShuttleTasksModuleAvailable: isShuttleTasksModuleAvailable,
        isIndividualSubscription: isIndividualSubscription,
      })
  ...
  changeTaskDueDate(
    ...
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/task-due-date`, {
  ...
  updateGanttTasksDates(
    ...
    // Call the HTTP Request
    return this._http
      .post(this.baseURL + `/${postId}/timeline-task-dates-update`, {
        date_due_to: dateDueTo,
  ...
  changeTaskStatus(
    ...
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/task-status`, {
        status: status,
        userId: userId,
        groupId: groupId,
        isShuttleTasksModuleAvailable: isShuttleTasksModuleAvailable,
  ...
  changeTaskColumn(
    ...
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/task-column`, {
        columnId: columnId,
        userId: userId,
        groupId: groupId,
        isShuttleTasksModuleAvailable: isShuttleTasksModuleAvailable,
  ...
  saveCustomField(
    ...
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/customField`, {
  ...
  getWorkspacePosts(
    ...
    return this._http
      .get(this.baseURL + `/workspace/posts`, {
        params: {
  ...
  getProjectTasks(groupId: string, overdue: boolean) {
    ...
    return this._http
      .get(this.baseURL + `/project/tasks`, {
        params: params,
      })
      .toPromise();
  }
  ...
  saveTaskDates(postId: any, newDate: any, date_field: string) {
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/${postId}/update-date`, {
        newDate: newDate,
  ...
  getSubTasks(taskId: string) {
    return this._http
      .get(this.baseURL + `/post/subtasks`, {
        params: {
  ...
  getSubTasksCount(taskId: string) {
    return this._http
      .get(this.baseURL + `/post/subtasks-count`, {
        params: {
          parentId: taskId.toString().trim(),
        },
      })
  ...
  transferToGroup(
    ...
    if (isCopy) {
      return this._http
        .post(this.baseURL + `/${postId}/copy-to-group`, {
          postId: postId,
          groupId: groupId,
          columnId: columnId,
    ...
    return this._http
      .put(this.baseURL + `/${postId}/move-to-group`, {
        groupId: groupId,
        columnId: columnId || "",
        oldGroupId: oldGroupId,
        userId: userId,
  ...
  removeAttachedFile(fileName: string, postId: string) {
    return this._http
      .post(this.baseURL + `/${postId}/delete-attached`, {
        fileName: fileName,
      })
      .toPromise();
  }
  ...
  searchPosibleParents(
    ...
    // Call the HTTP Request
    return this._http
      .get(this.baseURL + `/${currentPostId}/searchParent`, {
        params: {
          groupId: groupId,
          query: queryText,
          field: type,
  ...
  setParentTask(taskId: string, parentTaskId: string) {
    return this._http
      .put(this.baseURL + `/${taskId}/set-parent`, {
  ...
  setDependencyTask(taskId: string, dependencyTaskId: string) {
    return this._http
      .put(this.baseURL + `/${taskId}/set-dependency`, {
  ...
  removeDependencyTask(taskId: string, dependencyTaskId: string) {
    return this._http
      .put(this.baseURL + `/${taskId}/remove-dependency`, {
        dependencyTaskId: dependencyTaskId,
      })
      .toPromise();
  }
  ...
  cloneToAssignee(assignees: any, postId: string) {
    return this._http
      .post(this.baseURL + `/${postId}/clone-to-assignee`, {
        postId: postId,
        assignees: assignees,
      })
      .toPromise();
  ...
  getGroupTemplates(groupId: string) {
    return this._http
      .get(this.baseURL + `/post/templates`, {
        params: {
          groupId: groupId,
        },
      })
  ...
  createTemplate(postId: string, groupId: string, templateName: any) {
    return this._http
      .post(this.baseURL + "/create-template", {
        postId: postId,
        groupId: groupId,
  ...
  overwriteTemplate(postId: string, templateId: string, templateName: string) {
    return this._http
      .put(this.baseURL + `/${postId}/overwrite-template`, {
  ...
  createTaskFromTemplate(templatePostId: string, postId: string) {
    return this._http
      .post(this.baseURL + "/create-task-from-template", {
  ...
  saveAllocation(allocation: string, postId: string) {
    return this._http
      .put(this.baseURL + `/${postId}/save-allocation`, {
  ...
  saveEstimation(estimation: any, postId: string) {
    return this._http
      .put(this.baseURL + `/${postId}/save-estimation`, {
  ...
  pinToTop(postId: string, pin: boolean) {
    return this._http
      .put(this.baseURL + `/${postId}/pin-to-top`, {
        pin: pin,
      })
      .toPromise();
  }
  ...
  voteIdea(postId: string, voteValue: number) {
    return this._http
      .put(this.baseURL + `/${postId}/vote-idea`, {
        vote: voteValue,
      })
      .toPromise();
  }
  ...
  selectShuttleGroup(postId: string, shuttleGroupId: string) {
    return this._http
      .put(this.baseURL + `/${postId}/selectShuttleGroup`, {
  ...
  selectShuttleSection(
    ...
    return this._http
      .put(this.baseURL + `/${postId}/selectShuttleSection`, {
  ...
  selectShuttleStatus(
    ...
    return this._http
      .put(this.baseURL + `/${postId}/selectShuttleStatus`, {
  ...
  selectPermissionRight(permissionId: string, postId: string, right: string) {
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/post/permissions/${postId}/selectPermissionRight`, {
        right,
        permissionId,
      })
      .toPromise();
  ...
  removePermission(permissionId: string, postId: string) {
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/post/permissions/${postId}/removePermission`, {
        permissionId,
      })
      .toPromise();
  }
  ...
  addTagToPermission(permissionId: string, postId: string, tag: string) {
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/post/permissions/${postId}/addTagToPermission`, {
        permissionId,
        tag,
      })
      .toPromise();
  ...
  removePermissionTag(permissionId: string, postId: string, tag: string) {
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/post/permissions/${postId}/removePermissionTag`, {
        permissionId,
        tag,
      })
      .toPromise();
  ...
  addMemberToPermission(postId: string, permissionId: string, member: any) {
    // Call the HTTP Request
    return this._http
      .put(this.baseURL + `/post/permissions/${postId}/addMemberToPermission`, {
        permissionId,
        member,
      })
      .toPromise();
  ...
  removeMemberFromPermission(
    ...
    return this._http
      .put(
        this.baseURL + `/post/permissions/${postId}/removeMemberFromPermission`,
        { permissionId, memberId }
      )
      .toPromise();
  }
  /**
  ...
  saveCRMInfo(postId: string, crm_info: any) {
    return this._http
      .put(this.baseURL + `/${postId}/saveCRMInfo`, { crm_info })
      .toPromise();
  }

  recalculateCost(postId: string) {
    return this._http
      .post(this.baseURL + `/${postId}/recalculateCost`, {})
      .toPromise();
  }
      ...
      return tasks?.sort((t1, t2) => {
        if (sortingBit == "due_date" || sortingBit == "none") {
          if (t1.task?.due_to && t2.task?.due_to) {
            if (
              datesService.isBefore(
                DateTime.fromISO(t1.task?.due_to),
                DateTime.fromISO(t2.task?.due_to)
              )
            ) {
          ...
          if (t1.created_date && t2.created_date) {
            if (
              datesService.isBefore(
                DateTime.fromISO(t1.created_date),
                DateTime.fromISO(t2.created_date)
              )
            ) {
          ...
          if (sortingData && sortingData.name == "priority") {
            ...
            return t1?.task?.custom_fields && t2?.task?.custom_fields
              ? t1?.task?.custom_fields[sortingData.name] &&
                t2?.task?.custom_fields[sortingData.name]
                ? t1?.task?.custom_fields[sortingData.name] >
                  t2?.task?.custom_fields[sortingData.name]
                  ? -1
                  : t1?.task?.custom_fields < t2?.task?.custom_fields
          ...
          return t1?.task?.status && t2?.task?.status
            ? (t1?.task?.status == "to do" && t2?.task?.status != "to do") ||
              (t1?.task?.status == "in progress" && t2?.task?.status == "done")
              ? -1
              : (t1?.task?.status != "to do" && t2?.task?.status == "to do") ||
                (t1?.task?.status == "done" &&
                  t2?.task?.status == "in progress")
              ? 1
              : 0
          ...
          return (t1?.task?.idea?.positive_votes?.length ||
            0 - t1?.task?.idea?.negative_votes?.length ||
            0) >
            (t2?.task?.idea?.positive_votes ||
              0 - t2?.task?.idea?.negative_votes ||
              0)
            ? -1
            : 1;
        }
  ...
  async filterTasks(
    ...
    return tasks?.filter((task: any) => {
      if (filteringBit == "mytask") {
        ...
        return task?.task?.due_to
          ? this.datesService.isBefore(
              DateTime.fromISO(task?.task?.due_to),
              DateTime.now()
            )
          : false;
        ...
        return (
          ...
          task.task.custom_fields[filteringData.name] == filteringData.value
        );
  ...
  async exportTasksTo(
    ...
    for (let i = 0; i < sections.length; i++) {
      ...
      section.tasks = await this.getTasksBySectionPromise(
        section?._id,
        isShuttleTasksModuleAvailable
      );

      if (groupData?.enabled_rights) {
        section.tasks = await this.filterRAGTasks(
          section.tasks,
          groupData,
          userData
        );
      ...
      for (let j = 0; j < section.tasks.length; j++) {
        ...
        let task: any = {
          title: post.title || "",
          posted_by:
            post && post._posted_by
              ? post?._posted_by?.first_name + " " + post?._posted_by?.last_name
              : "",
          created_date: post?.created_date
            ? this.datesService.formateDate(
                DateTime.fromISO(post?.created_date),
                "MMM D, YYYY HH:mm"
              )
            : "",
          tags: post.tags || "",
        ...
        if (post.task.start_date) {
          task.due_to = post.task.start_date
            ? this.datesService.formateDate(post.task.start_date, "MMM D, YYYY")
            : "";
        }
        task.due_to = post.task.due_to
          ? this.datesService.formateDate(post.task.due_to, "MMM D, YYYY")
          : "";
    ...
    groupService.exportTasksToFile(
      exportType,
      exportTasks,
      groupData?.group_name + "_tasks"
    );
  }

  saveRecurrency(postId: any, is_recurrent: any, recurrent: any) {
    return this._http
      .post(this.baseRecurrencyURL + `/${postId}`, {
