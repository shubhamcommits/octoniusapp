...
export class GroupService {
  ...
  archiveGroup(groupId: string, archive: boolean) {
    return this._http
      .put(this.baseURL + `/${groupId}/archive`, { archive: archive })
      .toPromise();
  }
  ...
  updateGroup(groupId: string, groupData: any) {
    return this._http
      .put(this.baseURL + `/${groupId}`, { groupData })
      .toPromise();
  }
  ...
  updateGroupImage(
    ...
    return this._http
      .put(this.baseURL + `/${groupId}/image/${workspaceId}`, formData)
      .toPromise();
  }
  ...
  getGroupMembersSocialStats(groupId: string, numDays: string) {
    return this._http
      .get(this.baseURL + `/members/social-stats`, {
        params: {
          groupId: groupId,
          numDays: numDays,
        },
  ...
  addNewUserToGroup(groupId: string, member: any) {
    ...
    return this._http.post(this.baseURL + `/members/add`, bodyData).toPromise();
  }
  ...
  changeUserRoleInGroup(groupId: string, role: string, userId: string) {
    ...
    return this._http
      .post(this.baseURL + `/members/changeUserRole`, bodyData)
      .toPromise();
  }
  ...
  removeUser(groupId: string, userId: string) {
    ...
    return this._http
      .post(this.baseURL + `/members/remove`, bodyData)
      .toPromise();
  }
  ...
  addRag(groupId: string, ragTag: string) {
    ...
    return this._http
      .put(this.baseURL + `/${groupId}/addRag`, bodyData)
      .toPromise();
  }
  ...
  removeRag(groupId: string, ragTag: string) {
    ...
    return this._http
      .put(this.baseURL + `/${groupId}/removeRag`, bodyData)
      .toPromise();
  }
  ...
  addMemberToRag(groupId: string, ragTag: string, member) {
    ...
    return this._http
      .post(this.baseURL + `/members/addToRag`, bodyData)
      .toPromise();
  }
  ...
  removeUserFromRag(groupId: string, ragTag: string, member) {
    ...
    return this._http
      .post(this.baseURL + `/members/removeFromRag`, bodyData)
      .toPromise();
  }
  ...
  saveNewCustomField(
    newCustomField: { name: string; title: string; values: any[] },
    groupId: any
  ) {
    return this._http
      .put(this.baseURL + `/${groupId}/customFields`, { newCustomField })
      .toPromise();
  }

  getGroupCustomFields(groupId: string) {
    return this._http
      .get(this.baseURL + `/${groupId}/customFields`)
      .toPromise();
  }

  removeCustomField(fieldId: string, groupId: string) {
    return this._http
      .delete(this.baseURL + `/${groupId}/customFields/${fieldId}`)
      .toPromise();
  }

  addCustomFieldNewValue(value: string, fieldId: string, groupId: string) {
    return this._http
      .put(this.baseURL + `/${groupId}/customFields/addValue`, {
        fieldId,
        value,
      })
      .toPromise();
  ...
  setCustomFieldDisplayKanbanCard(
    display_in_kanban_card: boolean,
    fieldId: string,
    groupId: string
  ) {
    return this._http
      .put(this.baseURL + `/${groupId}/customFields/displayInKanbanCard`, {
        fieldId,
  ...
  setCustomFieldColor(color: string, fieldId: string, groupId: string) {
    return this._http
      .put(this.baseURL + `/${groupId}/customFields/color`, { fieldId, color })
      .toPromise();
  }

  removeCustomFieldValue(value: string, fieldId: string, groupId: string) {
    return this._http
      .put(this.baseURL + `/${groupId}/customFields/removeValue`, {
        fieldId,
        value,
      })
      .toPromise();
  ...
  saveNewFilesCustomField(
    newCustomField: { name: string; title: string; values: any[] },
    groupId: any
  ) {
    return this._http
      .put(this.baseURL + `/${groupId}/filesCustomFields`, { newCustomField })
      .toPromise();
  }

  getGroupFilesCustomFields(groupId: string) {
    return this._http
      .get(this.baseURL + `/${groupId}/filesCustomFields`)
      .toPromise();
  }

  removeFilesCustomField(fieldId: string, groupId: string) {
    return this._http
      .delete(this.baseURL + `/${groupId}/filesCustomFields/${fieldId}`)
      .toPromise();
  }

  addFilesCustomFieldNewValue(value: string, fieldId: string, groupId: string) {
    return this._http
      .put(this.baseURL + `/${groupId}/filesCustomFields/addValue`, {
        fieldId,
        value,
      })
      .toPromise();
  ...
  setFilesCustomFieldColor(color: string, fieldId: string, groupId: string) {
    return this._http
      .put(this.baseURL + `/${groupId}/filesCustomFields/color`, {
        fieldId,
        color,
      })
      .toPromise();
  ...
  removeFilesCustomFieldValue(value: string, fieldId: string, groupId: string) {
    return this._http
      .put(this.baseURL + `/${groupId}/filesCustomFields/removeValue`, {
        fieldId,
        value,
      })
      .toPromise();
  ...
  saveSettings(groupId: string, settingsData: any) {
    return this._http
      .put(this.baseURL + `/${groupId}/settings`, { settingsData })
      .toPromise();
  }

  selectShuttleSection(groupId: string, columnId: string) {
    return this._http
      .put(this.baseURL + `/${groupId}/settings/selectShuttleSection`, {
        columnId: columnId,
      })
      .toPromise();
  }
  ...
  deleteSmartGroupRule(
    ...
    return this._http.put<any>(
      `${this.baseURL}/smart/${groupId}/${rule}/${customFieldId}`,
      null
    );
  }
  ...
  getPostsCount(groupId: string, period: any) {
    return this._http
      .get(this.baseURL + `/${groupId}/postsCount`, {
        params: {
          period: period,
        },
      })
  ...
  getGroupTasksBetweenDays(groupId: string, startDate: any, endDate: any) {
    return this._http
      .get(this.baseURL + `/${groupId}/tasks-between-days`, {
        params: {
          startDate: startDate,
          endDate: endDate,
        },
  ...
  saveSelectedWidgets(groupId: string, selectedWidgets: string[]) {
    return this._http
      .put<any>(`${this.baseURL}/${groupId}/saveSelectedWidgets`, {
  ...
  getShuttleTasks(groupId: string) {
    return this._http
      .get(this.baseURL + `/${groupId}/shuttleTasks`)
      .toPromise();
  }
  ...
  saveCFTableWidgetSettings(groupId: string, settings: any) {
    return this._http
      .put<any>(`${this.baseURL}/${groupId}/saveCustomFieldsSettings`, {
        settings: settings,
      })
      .toPromise();
  }
  ...
  saveTimeTrackingEntry(groupId: string, newTimeTrackingEntity) {
    return this._http
      .put(this.baseURL + `/${groupId}/timeTrackingEntry`, {
        newTimeTrackingEntity,
      })
      .toPromise();
  }
  ...
  recalculateCost(timeTrackingEntityId: string, timeId: string) {
    return this._http
      .post(
        this.baseURL + `/${timeTrackingEntityId}/recalculateCost/${timeId}`,
        {}
      )
      .toPromise();
  }
  ...
  editTimeTrackingEntry(editTimeTrackingEntity, propertyEdited: string) {
    return this._http
      .post(this.baseURL + `/${editTimeTrackingEntity._id}/timeTrackingEntry`, {
        editTimeTrackingEntity,
        propertyEdited,
      })
      .toPromise();
  }
  ...
  removeTimeTrackingEntity(timeTrackingEntityId: string, timeId: string) {
    return this._http
      .delete(
        this.baseURL +
          `/${timeTrackingEntityId}/removeTimeTrackingEntity/${timeId}`
      )
      .toPromise();
  }
  ...
  getTimeTrackingEntities(postId: string) {
    return this._http
      .get(this.baseURL + `/${postId}/timeTrackingEntities`)
      .toPromise();
  }

  getTimeTrackingCategories(groupId: string) {
    return this._http
      .get(this.baseURL + `/${groupId}/timeTrackingCategories`)
      .toPromise();
  }

  saveNewTimeTrackingCategory(newCategory: any, groupId) {
    return this._http
      .put(this.baseURL + `/${groupId}/newTimeTrackingCategory`, {
        newCategory,
      })
      .toPromise();
  }
  ...
  removeTimeTrackingCategory(categoryId, groupId) {
    return this._http
      .delete(
        this.baseURL + `/${groupId}/removeTimeTrackingCategory/${categoryId}`
      )
      .toPromise();
  }
  ...
  getGroupTimeTrackingEntites(
    ...
    return this._http
      .get(this.baseURL + `/${groupId}/time-tracking-entities`, {
        params: {
          startDate: startDate,
          endDate: endDate,
  ...
  getMultipleGroupsTimeTrackingEntites(
    groups: any,
    startDate: any,
    endDate: any
  ) {
    return this._http
      .get(this.baseURL + `/null/multiple-groups-time-tracking-entities`, {
        params: {
          groups: groups,
          startDate: startDate,
          endDate: endDate,
  ...
  getSectionTimeTrackingEntities(sectionId: string) {
    return this._http
      .get(this.baseURL + `/${sectionId}/time-tracking-entities-by-section`, {})
      .toPromise();
  }

  getMembersFromMultipleGroups(groups: any) {
    return this._http
      .get(this.baseURL + `/members/members-from-multiple-groups`, {
        params: {
          groups: groups,
        },
      })
  ...
  getMultipleGroupsTasksBetweenDays(groups: any, startDate: any, endDate: any) {
    return this._http
      .get(this.baseURL + `/null/tasks-between-days-multiple-groups`, {
        params: {
          groups: groups,
          startDate: startDate,
          endDate: endDate,
  ...
  async navigateToGroup(group: any) {
    ...
    const newGroup: any = await this.publicFunctions.getGroupDetails(
      group?._id
    );
    ...
    if (!newGroup.pages_to_show) {
      if (group.type == "resource") {
        this.utilityService
          ...
          .emit("groups_resource");
        router.navigate(["dashboard", "work", "groups", "resource"]);
      } else {
        this.utilityService
          .handleActiveStateTopNavBar()
          .emit("groups_activity");
        router.navigate(["dashboard", "work", "groups", "activity"]);
      }
    } else if (
      newGroup.pages_to_show.resource_management &&
      newGroup?.type == "resource"
    ) {
