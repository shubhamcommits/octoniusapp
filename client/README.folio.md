...
4. The previous implementation is kept as it is and the new implementation is in other component named FolioEditor2 [`Previous implementation is kept as it is for safety purpose`]
