...
# Backup
```
mongodump --host mongo-0-mongo:27017 --forceTableScan --db=octonius --out=/prod_tmp/octonius_dump
...
DESTNATION_HOSTNAME=mongo-0.mongo:27011  ( mongo db host name on which you want to restore database you backup )
...
step-5) prod_restore.sh = ( for restoring the backup database that we done in step 3 to the mongodb replicaset cluster )
```
