...
function devConfigInit() {
  ...
  process.env.LIBREOFFICE_SERVER = `http://${process.env.LIBREOFFICE_DOMAIN}:${process.env.LIBREOFFICE_PORT}`
  process.env.LIBREOFFICE_SERVER_API = `http://${process.env.LIBREOFFICE_DOMAIN}:${process.env.LIBREOFFICE_PORT}/api`
};
