...
//const serviceAccount = require("../../configs/octonius-mobile-firebase-adminsdk.json");
admin.initializeApp({
    credential: admin.credential.cert("../../configs/octonius-mobile-firebase-adminsdk.json")
});
