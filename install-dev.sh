...
# Else package manager is yarn
    ...
    serviceArray=( 'mailing/server' 'authentication/server' 'groups/server' 'workspaces/server' 'users/server' 'utilities/server' 'sockets/server' 'posts/server' 'client-upgrade/client' )
