...
export class NormalGroupPostComponent implements OnInit, OnDestroy {
  ...
  // // When we edit the post we will have to pass values to the datepicker, timepicker and assignUsers modals
  // THIS IS NOT NEEDED IN NORMAL GROUP POSTS
  // selectedGroupUsers = [];
  // model_date;
  // model_time;
  ...
  resetEditPostForm() {
    ...
    // this.model_time = {hour: 13, minutes: 30};
    this.edit_content = '';
    this.content_mentions = [];
